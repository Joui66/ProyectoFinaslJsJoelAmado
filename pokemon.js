...
const pokemonData = [
  ...
  { name: "Cloyster", id: 91, types: ["Agua", "Hielo"] },
  { name: "Gastly", id: 92, types: ["Fantasma", "Veneno"] },
  { name: "Haunterr", id: 93, types: ["Fantasma", "Veneno"] },
  { name: "Gengar", id: 94, types: ["Fantasma", "Veneno"] },
  { name: "Onix", id: 95, types: ["Roca", "Tierra"] },
  { name: "Drowzee", id: 96, types: ["Psíquico"] },
  { name: "Hypno", id: 97, types: ["Psíquico"] },
  { name: "Krabby", id: 98, types: ["Agua"] },
  { name: "Kingler", id: 99, types: ["Agua"] },
  { name: "Voltorb", id: 100, types: ["Eléctrico"] },
  { name: "Electrode", id: 101, types: ["Eléctrico"] },
  { name: "Exeggucute", id: 102, types: ["Planta", "Psíquico"] },
  { name: "Exeggutor", id: 103, types: ["Planta", "Psíquico"] },
  { name: "Cubone", id: 104, types: ["Tierra"] },
  { name: "Marowak", id: 105, types: ["Tierra"] },
  { name: "Hitmonlee", id: 106, types: ["Lucha"] },
  { name: "Hitmonchan", id: 107, types: ["Lucha"] },
  { name: "Lickitung", id: 108, types: ["Normal"] },
  { name: "Koffing", id: 109, types: ["Veneno"] },
  { name: "Weezing", id: 110, types: ["Veneno"] },
  { name: "Rhyhorn", id: 111, types: ["Tierra", "Roca"] },
  { name: "Rhydon", id: 112, types: ["Tierra", "Roca"] },
  { name: "Chansey", id: 113, types: ["Normal"] },
  { name: "Tangela", id: 114, types: ["Planta"] },
  { name: "Kangaskhan", id: 115, types: ["Normal"] },
  { name: "Horsea", id: 116, types: ["Agua"] },
  { name: "Seadra", id: 117, types: ["Agua"] },
  { name: "Goldeen", id: 118, types: ["Agua"] },
  { name: "Seaking", id: 119, types: ["Agua"] },
  { name: "Staryu", id: 120, types: ["Agua"] },
  { name: "Starmie", id: 121, types: ["Agua", "Psíquico"] },
  { name: "Mr.Mine", id: 122, types: ["Psíquico", "Hada"] },
  { name: "Scyther", id: 123, types: ["Bicho", "Volador"] },
  { name: "Jynx", id: 124, types: ["Hielo", "Psíquico"] },
  { name: "Electabuzz", id: 125, types: ["Eléctrico"] },
  { name: "Magmar", id: 126, types: ["Fuego"] },
  { name: "Pinsir", id: 127, types: ["Bicho"] },
  { name: "Tauros", id: 128, types: ["Normal"] },
  { name: "Magikarp", id: 129, types: ["Agua"] },
  { name: "Gyarados", id: 130, types: ["Agua", "Volador"] },
  { name: "Lapras", id: 131, types: ["Agua", "Hielo"] },
  { name: "Ditto", id: 132, types: ["Normal"] },
  { name: "Eevee", id: 133, types: ["Normal"] },
  { name: "Vaporeon", id: 134, types: ["Agua"] },
  { name: "Jolteon", id: 135, types: ["Eléctrico"] },
  { name: "Flareon", id: 136, types: ["Fuego"] },
  { name: "Porygon", id: 137, types: ["Normal"] },
  { name: "Omanyte", id: 138, types: ["Roca", "Agua"] },
  { name: "Omastar", id: 139, types: ["Roca", "Agua"] },
  { name: "Kabuto", id: 140, types: ["Roca", "Agua"] },
  { name: "Kabutops", id: 141, types: ["Roca", "Agua"] },
  { name: "Aerodactyl", id: 142, types: ["Roca", "Volador"] },
  ...
  { name: "Dratini", id: 147, types: ["Dragón"] },
  { name: "Dragonair", id: 148, types: ["Dragón"] },
